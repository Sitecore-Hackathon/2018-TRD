namespace Sitecore.Foundation.SitecoreExtensions.Extensions
{
	...
	public static class ItemExtensions
    {
		...
		public static Item GetFirstDescendantOfTemplate(this Item item, ID templateID)
		{
			if (item == null)
				throw new ArgumentNullException(nameof(item));

			return item.Axes.GetDescendants().FirstOrDefault(i => i.IsDerived(templateID));
		}
		...
		public static Item GetItemByID(this ID id)
		{
			return Sitecore.Context.Site.Database.GetItem(id);
		}
